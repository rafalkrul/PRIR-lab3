...
public class Mandlebrot extends Thread {
...
//ustawienie 4 wątków generujących fraktal w 4 ćwiartkach
        Mandlebrot thread0 = new Mandlebrot(0);
        Mandlebrot thread1 = new Mandlebrot(1);
        Mandlebrot thread2 = new Mandlebrot(2);
        Mandlebrot thread3 = new Mandlebrot(3);
        thread0.start();
        thread1.start();
        thread2.start();
        thread3.start();
